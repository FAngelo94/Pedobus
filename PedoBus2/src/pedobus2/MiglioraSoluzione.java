...
public class MiglioraSoluzione {
    ...
    int usati[];
    Ottimizza o;
    public MiglioraSoluzione()
    {
        
    }
    
    public int esegui(Ottimizza ottimo, int profonditaPartenza, double archiMigliori[][], int tipologia)
    {
        ...
        if(tipologia==0)
            singola=new SingolaSoluzione(o, archi, indexArchi, rami, usati, 0);
        else
            singola2=new SingolaSoluzione2(o, archi, indexArchi, rami, usati, 0);
        return profonditaPartenza;
    }
}
